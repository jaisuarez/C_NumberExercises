...
int main()
{
    // Holds the user input to be checked if it is Keith Number or not
    int userInput = 0;

    // Holds the copy of the user input
    int userInputCopy = 0;

    // An array holding last n numbers of a Keith Series
    int keithSeries[10];
    ...
    // A flag that determines if the input number is a Keith Number
    int isKeithNumber;

    printf("\n\nCheck whether a number is Keith or not :\n");
    printf("Sample Keith Numbers: 197, 742, 1104,1537...\n");
    printf("--------------------------------------------\n");
    ...
    while (processHasCompleted == 0)
    {
        ...
        // Reset value of sum to calculate for the next Keith Number
        // in the series
        sum = 0;
